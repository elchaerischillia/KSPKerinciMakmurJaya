...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">DATA FAQ KOPERASI</li>
        </ol>
    </section>
    <!-- /.breadcrumb-->
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">DAFTAR DATA FAQ</h3>

                <div class="box-tools pull-right">
                    <a href="{{ route('faq.create') }}" class="btn btn-success btn-sm btn-flat">
                        <i class="fa fa-plus"></i> TAMBAH DATA FAQ
                    </a>
                </div>
            </div><!-- /.box-header -->
                    ...
                    <tbody>
                        @forelse ($faqs as $faq)
                            <tr data-entry-id="{{ $faq->id }}">
                                ...
                                <td>{{ \Illuminate\Support\Str::limit(strip_tags($faq->jawaban), 50, '...') }}</td>
                                <td>
                                    @if ($faq->status === 'aktif')
