                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori_pinjaman_id" id="kategori_pinjaman_id" class="form-control select2">
                                ...
                                @foreach ($kategori_pinjaman as $kp)
                                    <option value="{{ $kp->id }}"
                                        {{ old('kategori_pinjaman_id') == $kp->id ? 'selected' : '' }}>
                                        {{ $kp->nama_kategori }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="bulan" value="{{ old('bulan') }}" required>
                            @error('bulan')
                                <span class="help-block text-red">
                                    <small>{{ $message }}</small>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nominal" id="rupiah" value="{{ old('nominal') }}">
                            @error('nominal')
                                <span class="help-block text-red">
                                    <small>{{ $message }}</small>
                                </span>
